...
let violations = 0;
console.log('📊 Weekly article distribution (first 50 weeks):');
sortedWeeks.slice(0, 50).forEach(week => {
...
console.log(\`⚠️  Violations (0 or >3): \${violations}\`);
console.log(\`✅  System is healthy if violations = 0 and all weeks have 1-3 articles\`);
"