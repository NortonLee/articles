---
layout: post
title: "TypeScript strict 模式开启实践"
category: TypeScript
tags: ['TypeScript', 'strict']
date: 2018-10-15
---

# TypeScript strict 模式开启实践

> *2018-10-15 | TypeScript | 预计阅读 5 分钟*

## 概述

TypeScript strict 模式开启实践是2018年前端开发中的重要技术话题。在Vue 2.x生态中，掌握这一技能对提升开发效率至关重要。
...
TypeScript strict 模式开启实践 是提升开发效率的关键技术。建议结合实际项目多加练习，持续跟进技术更新。
