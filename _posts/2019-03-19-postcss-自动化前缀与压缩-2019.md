...
> *2019-03-19 | 构建工具 | 预计阅读 7 分钟*

## 概述

PostCSS 自动化前缀与压缩是2019年前端开发中的重要技术话题。在Vue 2.x生态中，掌握这一技能对提升开发效率至关重要。
...
PostCSS 自动化前缀与压缩 是提升开发效率的关键技术。建议结合实际项目多加练习，持续跟进技术更新。
